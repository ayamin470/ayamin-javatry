...
public abstract class Ticket  {
    ...
    // TODO done ayamin 一応、インスタンス変数、コンストラクター、メソッドというの定義順序の基本ではあるので... by jflute (2025/09/05)
    // 少なくとも、コンストラクターよりも下のどこかに定義しましょう。
    // TODO jflute [質問] 調べたところではAttributeとインスタンス変数は厳密には異なるようですが、ここでは同じ意味で使っていますか？ by ayamin (2025/09/30)
