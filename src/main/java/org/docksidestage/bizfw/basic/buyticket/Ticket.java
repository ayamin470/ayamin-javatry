...
//    }
    ...
    public void doInPark() {
        ...
        if (nightOnly && DayNightChecker.isDay(currentTime)) {
            ...
            // TODO ayamin 細かいですが、変数名の先頭は小文字で (CurrentTime -> currentTime) by jflute (2025/07/31)
            // スコープ短いですが、IntelliJのrenameのショートカット機能を使ってrenameしてみましょう。(指トレーニング)
            // TODO ayamin 細かいですが、java.time.format.DateTimeFormatter のところ、FQCN じゃなくて良いと思います by jflute (2025/07/31)
